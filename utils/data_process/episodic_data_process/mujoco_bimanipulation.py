...
class MujocoBimanipulationDataProcessor(BaseDataProcessor):
    def __init__(self, 
                    source_dir:str,
                    target_dir:str,
    ...
    def _generate_episodic_data(self):
        ...
        for source_file in tqdm.tqdm(source_files):
            episodic_data =  self._read_file(source_file)
    ...
    def _read_file(self, hdf5_file)->List[EpisodicDataClass]:
        ...
        episodic_data = EpisodicDataClass(
