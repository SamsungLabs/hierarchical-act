...
class BaseDataProcessor():
    ...
    def process_data(self):
        for target_file, episodic_data in tqdm.tqdm(self._generate_episodic_data()):
    ...
    def _write_file(self,
                    target_file: str,
                    episodic_data: DomainEpisodicDataClass)->None:
        ...
        domain = episodic_data.domain
        success = episodic_data.success
    ...
    @abstractmethod
    def _generate_episodic_data(self)->Generator[Tuple[str, DomainEpisodicDataClass], None, None]:
